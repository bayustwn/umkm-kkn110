...
export default function MapPicker({
  onLocationSelect,
  initialLat = -7.2591052,
  initialLng = 112.6764528,
  mapStyle = 'cartodb',
}: MapPickerProps) {
  ...
  return (
    <div className="w-full">
      <div className="mb-4">
        <label className="block text-xl font-semibold text-black mb-2">Pilih Lokasi di Peta</label>
        <div className="text-sm text-gray-600 mb-2">Klik pada peta untuk memilih lokasi UMKM</div>
      ...
      <div className="mt-3 p-3 bg-gray-50 rounded-lg">
        ...
        <div className="text-sm font-mono">Latitude: {coordinates.lat.toFixed(6)}</div>
        <div className="text-sm font-mono">Longitude: {coordinates.lng.toFixed(6)}</div>
      </div>
    </div>
  );
}
