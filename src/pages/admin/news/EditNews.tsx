      ...
      <div className="mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-2 pt-2">
            ...
            <button type="submit" disabled={!canSubmit() || updateNews.isPending} className="px-6 py-2 bg-primary text-white rounded-full hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">{updateNews.isPending ? 'Memperbarui...' : 'Perbarui Berita'}</button>
          </div>
        </form>
      </div>
    </div>
